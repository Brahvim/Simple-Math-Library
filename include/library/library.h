...
int smlMat22Rank(struct SmlMat22 const *const matrix);
float smlMat22Trace(struct SmlMat22 const *const matrix);
char smlMat22IsSymmetric(struct SmlMat22 const *const matrix);
...
int smlMat22TraceDeterminantIdentityCheck(struct SmlMat22 const *const matrix);
...
struct SmlVec2* smlMat22Eigenvalues(struct SmlMat22 const *const matrix, struct SmlVec2 *const destination);
struct SmlMat22* smlMat22Transpose(struct SmlMat22 const *const matrix, struct SmlMat22 *const destination);
struct SmlMat22* smlMat22Rotate(struct SmlMat22 const *const matrix, float angle, struct SmlMat22 *const destination);
...
struct SmlMat22* smlMat22RowAdd(struct SmlMat22 const *const matrix, int rowIndex, float scalar, struct SmlMat22 *const destination);
...
struct SmlVec2* smlMat22MultVec2(struct SmlMat22 const *const matrix, struct SmlVec2 const *const vector, struct SmlVec2 *const destination);
...
int smlMat33Rank(struct SmlMat33 const *const matrix);
float smlMat33Trace(struct SmlMat33 const *const matrix);
char smlMat33IsSymmetric(struct SmlMat33 const *const matrix);
...
int smlMat33TraceDeterminantIdentityCheck(struct SmlMat33 const *const matrix);
...
struct SmlVec2* smlMat33Eigenvalues(struct SmlMat33 const *const matrix, struct SmlVec2 *const destination);
struct SmlMat33* smlMat33Transpose(struct SmlMat33 const *const matrix, struct SmlMat33 *const destination);
// struct SmlMat33* smlMat33Rotate(struct SmlMat33 const *const matrix, float angle, struct SmlMat33 *const destination);
...
struct SmlMat33* smlMat33RowAdd(struct SmlMat33 const *const matrix, int rowIndex, float scalar, struct SmlMat33 *const destination);
...
struct SmlVec3* smlMat33MultVec2(struct SmlMat33 const *const matrix, struct SmlVec3 const *const vector, struct SmlVec2 *const destination);
...
int smlMat44Rank(struct SmlMat44 const *const matrix);
float smlMat44Trace(struct SmlMat44 const *const matrix);
char smlMat44IsSymmetric(struct SmlMat44 const *const matrix);
...
int smlMat44TraceDeterminantIdentityCheck(struct SmlMat44 const *const matrix);
...
struct SmlVec2* smlMat44Eigenvalues(struct SmlMat44 const *const matrix, struct SmlVec2 *const destination);
struct SmlMat44* smlMat44Transpose(struct SmlMat44 const *const matrix, struct SmlMat44 *const destination);
struct SmlMat44* smlMat44Rotate(struct SmlMat44 const *const matrix, float angle, struct SmlMat44 *const destination);
...
struct SmlMat44* smlMat44RowAdd(struct SmlMat44 const *const matrix, int rowIndex, float scalar, struct SmlMat44 *const destination);
...
struct SmlVec2* smlMat44MultVec2(struct SmlMat44 const *const matrix, struct SmlVec2 const *const vector, struct SmlVec2 *const destination);
