...
inline struct SmlMat44* smlMat44Mul(
	struct SmlMat44 const *const p_first,
	struct SmlMat44 const *const p_second,
	struct SmlMat44 *const p_destination
) {
...
inline struct SmlMat44* smlMat44Add(
	struct SmlMat44 const *const p_first,
	struct SmlMat44 const *const p_second,
	struct SmlMat44 *const p_destination
) {
...
inline struct SmlMat44* smlMat44Sub(
	struct SmlMat44 const *const p_first,
	struct SmlMat44 const *const p_second,
	struct SmlMat44 *const p_destination
) {
...
inline struct SmlMat44* smlMat44MultMembers(
	struct SmlMat44 const *const p_first,
	struct SmlMat44 const *const p_second,
	struct SmlMat44 *const p_destination
) {
